...
## Описание
Космический шутер с сохранением прогресса в файле конфигурации (~/.config/spaceshooter/settings.ini).
...
## Сохранение данных
Игра сохраняет 20 значений в файле конфигурации:
`~/.config/spaceshooter/settings.ini`
...
## Примечание
В Linux вместо реестра Windows используется файл конфигурации INI, 
что является стандартным подходом для хранения настроек в Linux-системах.
